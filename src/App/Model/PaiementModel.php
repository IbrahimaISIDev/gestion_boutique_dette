...
class PaiementModel
{
    ...
    public function creerPaiement($detteId, $montant, $datePaiement)
    {
        $sql = "INSERT INTO paiements (dette_id, montant_verser, date_paiement) VALUES (?, ?, ?)";
    ...
    public function obtenirPaiementsParDetteId($detteId)
    {
        ...
        while ($row = $result->fetch()) {
            ...
            $paiement->montant = $row['montant_verser'];
